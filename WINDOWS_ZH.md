...
5. 如果 Vercel 询问"Framework Preset"，选 **Other** 或留空。
6. 保持默认，点 **"Deploy"**
7. 等十几秒，完成！
...
3. 在域名商 DNS 设置里添加 Vercel 给你的记录。请原样复制 — 这些记录是你项目专属的。
4. 等几分钟到几小时
...
| 创建文件夹 | `mkdir -p ~/Developer/my-website` | `mkdir -Force ~\Developer\my-website` |
...
**上线一个网站的最低成本：$0** — 只要你用有免费版的 AI 工具。

---

## 不想看文字？直接对话搞定

安装 **[zero-dollar-website-skill](https://github.com/che-3/zero-dollar-website-skill)** 到 Claude Code — 它会用对话的方式一步步带你完成整个流程。
